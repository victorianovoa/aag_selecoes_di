...
🔗 Link do Site
[(https://victorianovoa.github.io/aag_selecoes_di/)]

💗 Sobre o Projeto
O AAG Seleções é um sistema completo para organização de estudos e acompanhamento de concursos públicos.
Desenvolvido como projeto acadêmico para a disciplina de Desenvolvimento de Interfaces.
...
Listagem das 5 principais bancas (CEBRASPE, FCC, FGV, VUNESP, CESGRANRIO)
...
📄 Editais
Lista completa de editais
Sistema de filtros (busca, banca, status)
Infos detalhadas: vagas, salário, datas
Áreas de atuação
Links oficiais
...
Tipos: Estudo, Prova, Pagamento, Outros
Lista de próximos eventos
Legendas visuais por categoria
...
Instituição: adicione aqui
Desenvolvedor(a): adicione seu nome
Data: Dezembro 2025
